        ...
        <div className="bg-base-200 py-16 md:py-20">
            <div className="container mx-auto px-6 max-w-6xl text-neutral">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    <h2 className="text-3xl font-bold text-center mb-4 font-heading">Our Events</h2>
                ...
                <div className="grid md:grid-cols-2 items-center gap-16">
                    ...
                    <div>
                        <h3 className="text-2xl font-bold mb-4 font-heading">Open Mic: Speaking Out, Standing Strong</h3>
                    ...
                    <div className="max-md:order-1">
                        <h3 className="text-2xl font-bold mb-4 font-heading">Movie Screening - "Checkmate Turup"</h3>
                        <p className="text-base font-sans leading-relaxed">
