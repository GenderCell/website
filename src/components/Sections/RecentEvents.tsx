...
const RecentEvents: React.FC = () => {
    return (
        <div className="bg-[#ffe5d9] py-12">
            <div className="container mx-auto px-6 max-w-5xl text-[#333]">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    <h2 className="text-3xl font-extrabold text-center mb-4 font-serif">Our Events</h2>
                    <p className="text-sm font-serif">The events conducted by the Gender Cell at IIT Kanpur during the recent years.</p>
                </div>
                ...
                <div className="grid md:grid-cols-2 items-center gap-16">
                    ...
                    <div>
                        <h3 className="text-2xl font-extrabold mb-4 font-serif">Open Mic: Speaking Out, Standing Strong</h3>
                    ...
                    <div className="max-md:order-1">
                        <h3 className="text-2xl font-extrabold mb-4 font-serif">Movie Screening - "Checkmate Turup"</h3>
                        <p className="text-sm font-serif leading-relaxed">
