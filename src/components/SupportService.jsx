        ...
        <div className="contact-info-container">
          ...
          <div className="contact-info-content">
            ...
            <div>
              ...
              <p className="contact-info-paragraph">As per the <a href={pdfExports.sexual_harassment_act} className="contact-info-link" target="_blank" rel="noopener noreferrer">Sexual Harassment of Women at Workplace (Prevention, Prohibition, and Redressal) Act, 2013</a>, IIT Kanpur has established an <Link to="/icc" className="contact-info-link">Internal Complaints Committee (ICC)</Link> for filing complaints.</p>
            </div>
            <div>
              ...
              <ul className="contact-info-list">
                ...
                <li>Any student, irrespective of age and/or gender, may file a complaint against an incident of sexual harassment as per the <a href={pdfExports.rules_2017} className="contact-info-link" target="_blank" rel="noopener noreferrer">IIT Kanpur Prevention, Prohibition and Redressal of Sexual Harassment of Students Rules, 2017</a>. </li>
              </ul>
            </div>
            <div>
              <h3 className="contact-info-subtitle">How to Approach ICC</h3>
              <ul className="contact-info-list">
                <li>Call/email/meet/file a paper complaint to the Presiding Officer, ICC, and (<Link to="/icc" className="contact-info-link">Current Presiding Officer</Link>)</li>
                <li>Email: <a href="mailto:icc@iitk.ac.in" className="contact-info-link">icc@iitk.ac.in</a></li>
              </ul>
              <p className="contact-info-paragraph">Examples of <a href={pdfExports.offences_v4} className="contact-info-link" target="_blank" rel="noopener noreferrer">offences</a> and <a href={pdfExports.punishment_given_v3} className="contact-info-link" target="_blank" rel="noopener noreferrer">punishments given</a> in cases with ICC at IIT Kanpur (the two lists do not have one-to-one correspondence).</p>
            </div>
          </div>
        </div>
      </section>
