...
const HomeCard = ({ title, moreInfo, link,linkText, img, imgAlt }) => {
  return (
    <div>
      <div className=" py-4 lg:px-12 px-4 card-compact bg-base-100 max-w-full lg:mx-12 mx-6 shadow-xl lg:flex  hover:scale-[1.01] transition-all duration-500 ease-in-out">
        {/* text content */}
