...
const ContactFrom = () => {
  return (
    <div>
        <div className="w-full font-[sans-serif] max-w-7xl max-lg:max-w-3xl mx-auto p-4">
      <div className="bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded p-8">
        ...
        <div className="grid lg:grid-cols-2 items-start gap-12">
          ...
          <div className="grid sm:grid-cols-2  gap-12">
            ...
            <div className="flex items-start bg-white">
              <div className="shadow-[0_0px_2px_0px_rgba(6,81,237,0.3)] rounded px-3 py-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 fill-blue-600" viewBox="0 0 473.806 473.806">
              ...
              <div className="ml-6">
                ...
                <p className="text-sm text-gray-500 mt-1"> +158 996 888</p>
              </div>
            </div>
            ...
            <div className="flex items-start bg-white">
              ...
              <div className="ml-6">
                ...
                <p className="text-sm text-gray-500 mt-1">info@example.com</p>
              </div>
            </div>

            <div className="flex items-start bg-white">
              <div className="shadow-[0_0px_2px_0px_rgba(6,81,237,0.3)] rounded px-3 py-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 fill-blue-600" viewBox="0 0 100 100">
