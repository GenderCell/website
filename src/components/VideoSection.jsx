    ...
    <div className='ccc'>
      <div className='vediosection' id='videosec'>
        ...
        <div className='section1'>
          ...
          <div className='content1'>
            <h3>Consent It's as simple as tea.</h3><br/>
            <p>Consent is as simple as tea" is a popular analogy that explains the concept of consent using the act of offering someone a cup of tea. The analogy emphasizes that consent must be clear, enthusiastic, and can be withdrawn at any time.</p>
            <p>Source: <a href="https://www.youtube.com/watch?v=oQbei5JGiT8">https://www.youtube.com/watch?v=oQbei5JGiT8</a></p>
          </div>
        </div>
