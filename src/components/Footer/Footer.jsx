...
export const Footer = () => {
  return (
    <>
    <footer style={{backgroundColor:"black", color:"white"}} className="footer bg-base-200 text-base-content p-10">
  <aside>
    <svg
      width="50"
      height="50"
...
<footer style={{backgroundColor:"black", color:"white"}} className="footer footer-center bg-base-300 text-base-content p-4">
  <aside>
