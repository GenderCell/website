    ...
    <div className="bg-white text-black min-h-screen py-10 px-6 md:px-20">
      ...
      <div className="px-10">
        ...
        <p className="mb-6 text-lg">
          ...
          <strong> <a className="text-blue-600 underline ml-1 hover:text-blue-800" href={pdfExports.sexual_harassment_act}>Sexual Harassment of Women at Workplace (Prevention, Prohibition and Redressal) Act, 2013 </a> </strong>
          and  the Sexual Harassment of Women at Workplace (Prevention, Prohibition and Redressal) <a className="text-blue-600 underline ml-1 hover:text-blue-800" href={pdfExports.sexual_harassment_act}> Rules, 2013 </a>. The new rules applicable to faculty and staff at:
